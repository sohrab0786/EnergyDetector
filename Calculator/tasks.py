...
def run_simulation_simple(pk):
    ...
    output['total_save_area'] = str(round(float(output['heat_save_area']) + float(output['cool_save_area']), 2))
...
def run_simulation(pk):
    ...
    if emailid:
        subject = 'Cool Roof Calculator results'
        message = 'http://13.126.206.17:8000/display_results/' + str(pk) + "/"
        email_from = settings.EMAIL_HOST_USER
        recipient_list = [emailid]
...
def run_simulation_parametric(pk):
    ...
    if emailid:
        subject = 'Cool Roof Calculator results'
        message = 'http://13.126.206.17:8000/display_results_parametric/' + str(pk) + "/"
        email_from = settings.EMAIL_HOST_USER
        recipient_list = [emailid]
